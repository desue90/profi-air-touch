...
SENSOR_ENTITIES = {
    ...
    "filter_total_term": {"xml_tag": "filtertime", "unit": UnitOfTime.HOURS, "icon": "mdi:air-filter"},
    "filter_residual_term": {"xml_tag": "rest_time", "unit": UnitOfTime.HOURS, "icon": "mdi:air-filter"},
